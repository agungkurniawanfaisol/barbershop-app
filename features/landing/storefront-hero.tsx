...
export function StorefrontHero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-end px-4 pb-10 pt-24 text-center sm:px-6 sm:pb-14">
        <div className="mx-auto max-w-3xl space-y-5">
          ...
          <h1 className="font-display text-4xl leading-[1.05] font-semibold tracking-tight text-white text-balance sm:text-5xl md:text-6xl">
            Selamat datang di{" "}
